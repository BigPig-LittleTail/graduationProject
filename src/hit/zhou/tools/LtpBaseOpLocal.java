...
public class LtpBaseOpLocal{
    ...
    public LtpBaseOpLocal(final String modelPath,final String dicPath){
        this(modelPath);
            ...
            synchronized (this){
                if(!isCreateSegmentor){
                    if(dicPath.equals("")){
                        ...
                        baseSegmentorImp.create(modelPath + "cws.model",dicPath);
                    }
            ...
            synchronized (this){
                if(!isCreatePostaggerImp){
                    if(dicPath.equals("")){
                        ...
                        basePostaggerImp.create(modelPath + "pos.model",dicPath);
                    }
