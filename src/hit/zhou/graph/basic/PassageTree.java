...
public class PassageTree {
    ...
    private Function<String,PassageNode> nodeBuilder;
    ...
    public PassageTree(){
        this(PassageNode::new);
    }

    public PassageTree(Function<String,PassageNode> builder){
        root = null;
        isBuild = false;
        isNlp = false;
        isRdf = false;
    ...
    public void buildPassageTree(String passagePath,boolean isPassageChange) throws IOException{
        PassageNode passageNode = nodeBuilder.apply(passagePath);
        ...
        while(!queue.isEmpty()){
            ...
            for(File file:files){
                ...
                PassageNode childPassageNode = nodeBuilder.apply(file.getPath());
    ...
    public PassageNode getPassageNode(String passagePath){
        ...
        while(!queue.isEmpty()){
            passageNode = queue.poll();
            System.out.println(passageNode.getPassagePath());
